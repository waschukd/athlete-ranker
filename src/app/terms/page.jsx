    ...
    <main className="min-h-screen bg-gray-50 px-4 py-12">
      <article className="max-w-3xl mx-auto">
        ...
        <p className="text-gray-600 leading-relaxed mb-6">
          ...
          (<a href="https://sidelinestar.com" className="text-accent hover:underline">sidelinestar.com</a>) and
        ...
        <h2 className="font-display font-bold text-xl text-ink mt-10 mb-3">1. About the Service</h2>
        <p className="text-gray-600 leading-relaxed mb-6">
        ...
        <h2 className="font-display font-bold text-xl text-ink mt-10 mb-3">2. Eligibility and accounts</h2>
        ...
        <h2 className="font-display font-bold text-xl text-ink mt-10 mb-3">3. Account types</h2>
        <p className="text-gray-600 leading-relaxed mb-3">The Service has several role-based account types, each with different permissions:</p>
        ...
        <h2 className="font-display font-bold text-xl text-ink mt-10 mb-3">4. Acceptable use</h2>
        ...
        <h2 className="font-display font-bold text-xl text-ink mt-10 mb-3">5. Paid features (parent reports)</h2>
        <p className="text-gray-600 leading-relaxed mb-4">
        ...
        <h2 className="font-display font-bold text-xl text-ink mt-10 mb-3">6. Refunds</h2>
        ...
        <h2 className="font-display font-bold text-xl text-ink mt-10 mb-3">7. AI-generated content</h2>
        <p className="text-gray-600 leading-relaxed mb-6">
        ...
        <h2 className="font-display font-bold text-xl text-ink mt-10 mb-3">8. Your content</h2>
        <p className="text-gray-600 leading-relaxed mb-4">
        ...
        <h2 className="font-display font-bold text-xl text-ink mt-10 mb-3">9. Service availability and changes</h2>
        <p className="text-gray-600 leading-relaxed mb-6">
        ...
        <h2 className="font-display font-bold text-xl text-ink mt-10 mb-3">10. Termination</h2>
        <p className="text-gray-600 leading-relaxed mb-4">
        ...
        <h2 className="font-display font-bold text-xl text-ink mt-10 mb-3">11. Disclaimers</h2>
        <p className="text-gray-600 leading-relaxed mb-4">
        ...
        <h2 className="font-display font-bold text-xl text-ink mt-10 mb-3">12. Limitation of liability</h2>
        <p className="text-gray-600 leading-relaxed mb-4">
        ...
        <h2 className="font-display font-bold text-xl text-ink mt-10 mb-3">13. Indemnification</h2>
        <p className="text-gray-600 leading-relaxed mb-6">
        ...
        <h2 className="font-display font-bold text-xl text-ink mt-10 mb-3">14. Privacy</h2>
        <p className="text-gray-600 leading-relaxed mb-6">
          Your use of the Service is also governed by our{" "}
          <a href="/privacy" className="text-accent hover:underline">Privacy Policy</a>, which describes how
          we collect, use, and protect personal information. The Privacy Policy is incorporated
          into these Terms by reference.
        </p>

        <h2 className="font-display font-bold text-xl text-ink mt-10 mb-3">15. Governing law and disputes</h2>
        <p className="text-gray-600 leading-relaxed mb-6">
        ...
        <h2 className="font-display font-bold text-xl text-ink mt-10 mb-3">16. Changes to these Terms</h2>
        <p className="text-gray-600 leading-relaxed mb-6">
        ...
        <h2 className="font-display font-bold text-xl text-ink mt-10 mb-3">17. Contact</h2>
        <p className="text-gray-600 leading-relaxed mb-6">
