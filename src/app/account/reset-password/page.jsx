  ...
  if (!token) return (
    <div className="min-h-screen flex items-center justify-center px-4 bg-gray-50">
      <div className="text-center">
        ...
        <a href="/account/forgot-password" className="text-[#FF6B35] text-sm hover:underline mt-2 inline-block">Request a new one →</a>
      </div>
    </div>
  );
          ...
          {done ? (
            <div className="text-center space-y-4">
              ...
              <a href="/account/signin"
                className="inline-block w-full py-3 bg-[#FF6B35] text-white rounded-lg font-medium text-sm text-center hover:bg-[#E55A2E] transition-colors">
                Sign In →
              </a>
            </div>
          ) : (
