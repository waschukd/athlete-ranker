    ...
    <main className="min-h-screen bg-gray-50 px-4 py-12">
      <article className="max-w-3xl mx-auto">
        ...
        <p className="text-gray-600 leading-relaxed mb-6">
          ...
          (<a href="https://sidelinestar.com" className="text-accent hover:underline">sidelinestar.com</a>) and the
          Sideline Star Evaluator mobile app (collectively, the &ldquo;Service&rdquo;).
        </p>

        <h2 className="font-display font-bold text-xl text-ink mt-10 mb-3">1. Who we are</h2>
        <p className="text-gray-600 leading-relaxed mb-6">
        ...
        <h2 className="font-display font-bold text-xl text-ink mt-10 mb-3">2. Information we collect</h2>

        <h3 className="font-display font-semibold text-lg text-ink mt-6 mb-2">Account information</h3>
        <ul className="list-disc pl-6 space-y-1 text-gray-600 leading-relaxed mb-6">
        ...
        <h3 className="font-display font-semibold text-lg text-ink mt-6 mb-2">Evaluation data</h3>
        <ul className="list-disc pl-6 space-y-1 text-gray-600 leading-relaxed mb-4">
        ...
        <h3 className="font-display font-semibold text-lg text-ink mt-6 mb-2">Device and technical information</h3>
        <ul className="list-disc pl-6 space-y-1 text-gray-600 leading-relaxed mb-6">
        ...
        <h3 className="font-display font-semibold text-lg text-ink mt-6 mb-2">Voice audio (mobile app only)</h3>
        <p className="text-gray-600 leading-relaxed mb-6">
        ...
        <h3 className="font-display font-semibold text-lg text-ink mt-6 mb-2">Payment information</h3>
        <p className="text-gray-600 leading-relaxed mb-6">
        ...
        <h2 className="font-display font-bold text-xl text-ink mt-10 mb-3">3. How we use your information</h2>
        <ul className="list-disc pl-6 space-y-1 text-gray-600 leading-relaxed mb-4">
        ...
        <p className="text-gray-600 leading-relaxed mb-6">We do not use your information to show advertising. We do not sell your information.</p>

        <h2 className="font-display font-bold text-xl text-ink mt-10 mb-3">4. Who we share with (service providers)</h2>
        <p className="text-gray-600 leading-relaxed mb-3">The Service relies on a small number of trusted third-party providers:</p>
        <ul className="list-disc pl-6 space-y-1 text-gray-600 leading-relaxed mb-4">
        ...
        <p className="text-gray-600 leading-relaxed mb-6">Each provider is subject to its own privacy policy. We share only the data necessary to operate the relevant feature.</p>

        <h2 className="font-display font-bold text-xl text-ink mt-10 mb-3">5. Data retention and deletion</h2>
        ...
        <h2 className="font-display font-bold text-xl text-ink mt-10 mb-3">6. Security</h2>
        <p className="text-gray-600 leading-relaxed mb-6">
        ...
        <h2 className="font-display font-bold text-xl text-ink mt-10 mb-3">7. Children&rsquo;s data</h2>
        <p className="text-gray-600 leading-relaxed mb-6">
        ...
        <h2 className="font-display font-bold text-xl text-ink mt-10 mb-3">8. Canadian jurisdiction (PIPEDA, Quebec Law 25)</h2>
        <p className="text-gray-600 leading-relaxed mb-6">
        ...
        <h2 className="font-display font-bold text-xl text-ink mt-10 mb-3">9. Your rights</h2>
        <p className="text-gray-600 leading-relaxed mb-3">Depending on where you live, you may have the right to:</p>
        <ul className="list-disc pl-6 space-y-1 text-gray-600 leading-relaxed mb-4">
        ...
        <p className="text-gray-600 leading-relaxed mb-6">Contact us at the email below to exercise any of these rights.</p>

        <h2 className="font-display font-bold text-xl text-ink mt-10 mb-3">10. Changes to this policy</h2>
        <p className="text-gray-600 leading-relaxed mb-6">
        ...
        <h2 className="font-display font-bold text-xl text-ink mt-10 mb-3">11. Contact</h2>
        <p className="text-gray-600 leading-relaxed mb-6">
          Questions, requests, or privacy concerns:{" "}
          <a href="mailto:waschukd@gmail.com" className="text-accent hover:underline">waschukd@gmail.com</a>
        </p>
      </article>
    </main>
  );
