...
export function parentOnboardingHtml({ playerName: _pn, categoryName: _cn, orgName: _on }) {
  ...
  return emailWrapper(`
    ...
    ${infoCard("After evaluations", `<p style="margin:0;font-size:13px;color:#4a4f57;line-height:1.6;">A comprehensive Development Report will be available for purchase — collective evaluator feedback, an in-depth scouting analysis, and a personalized plan for ${esc(playerName)}.</p>`, { center: true })}
