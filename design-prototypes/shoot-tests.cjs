...
const OUT = "C:/Users/DA Waschuk/athlete-ranker/design-prototypes/tests-section.png";
...
(async () => {
  ...
  const p = await b.newPage({ viewport: { width: 800, height: 1400 }, deviceScaleFactor: 2 });
